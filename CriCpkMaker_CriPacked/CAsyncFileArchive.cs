...
namespace CriCpkMaker
{
  public class CAsyncFileArchive : IDisposable
  {
    ...
    private int m_file_attribute;
    private CCompFileCache m_compfilecache;
    private bool m_enable_comp_file_cache;
    ...
    {
      get => this.m_compfilecache.GetCacheDirectory();
      set
      {
        this.m_enable_comp_file_cache = !string.IsNullOrEmpty(value);
        this.m_compfilecache.SetCacheDirectory(value);
      }
    }

    public long CacheLimitSize
    {
      get => this.m_compfilecache.GetCacheLimitSize();
      set => this.m_compfilecache.SetCacheLimitSize(value);
    }

    public CAsyncFileArchive(int codec, CExternalBuffer extbuf)
    {
    ...
    {
      EnumCompressCodec compMode = this.m_comp_mode;
      switch (compMode)
      {
        ...
        case EnumCompressCodec.CodecDpkForceCrc:
          int dividedSize = this.m_divided_size;
          int num1 = (int) compMode;
          string str1 = "_";
          return num1.ToString() + str1 + "005" + str1 + dividedSize.ToString();
        case EnumCompressCodec.CodecLZMA:
          int num2 = this.m_file_attribute == 0 ? 0 : 5;
          CodecOptions codecOptions1 = this.m_codec_options;
          uint blockSize = codecOptions1.m_block_size;
          uint windowSize = codecOptions1.m_window_size;
          int num3 = 3;
          string str2 = "_";
          return num3.ToString() + str2 + "005" + str2 + windowSize.ToString() + "_" + blockSize.ToString() + "_" + num2.ToString();
        case EnumCompressCodec.CodecRELC:
          CodecOptions codecOptions2 = this.m_codec_options;
          uint romType = codecOptions2.m_rom_type;
          uint pageSize = codecOptions2.m_page_size;
          int num4 = 4;
          string str3 = "_";
          return num4.ToString() + str3 + "005" + str3 + pageSize.ToString() + "_" + romType.ToString();
        default:
          return ((int) compMode).ToString();
      }
    }

    private void Initialize(int codec)
    {
      ...
      this.m_compfilecache = new CCompFileCache();
      this.m_enable_comp_file_cache = true;
    }
...
label_7:
    ...
    public long ClearCacheFilesLimit() => this.m_compfilecache.ClearCacheFilesLimit();
    ...
    public void SetFileAttribute(int file_attribute) => this.m_file_attribute = file_attribute;
