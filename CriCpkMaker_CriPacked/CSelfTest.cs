  ...
  public class CSelfTest
  {
      ...
      string testAttrName)
    {
      ...
      if (\u003CModule\u003E.criCpkAnalyzer_GetHeaderInfoRtE(&criCpkAnalyzerTag, &cpkHeaderInfoTag, (void*) &arrayTypeBy0IaaD1, &criUtfHeapObj) == (CriCpkErrTag) 0)
      {
        ...
        ulong htocOffset = \u003CModule\u003E.criCpkHeaderInfo_GetHtocOffset(&cpkHeaderInfoTag);
        ulong htocSizeByte = \u003CModule\u003E.criCpkHeaderInfo_GetHtocSizeByte(&cpkHeaderInfoTag);
        ulong hgtocOffset = \u003CModule\u003E.criCpkHeaderInfo_GetHgtocOffset(&cpkHeaderInfoTag);
        ulong hgtocSizeByte = \u003CModule\u003E.criCpkHeaderInfo_GetHgtocSizeByte(&cpkHeaderInfoTag);
        ...
        this.PrintWriteLine(cb, string.Format("htoc  offs = 0x{0,8:X8} ({1,6})\r\n", (object) (uint) htocOffset, (object) (uint) htocSizeByte));
        this.PrintWriteLine(cb, string.Format("hgtoc offs = 0x{0,8:X8} ({1,6})\r\n", (object) (uint) hgtocOffset, (object) (uint) hgtocSizeByte));
