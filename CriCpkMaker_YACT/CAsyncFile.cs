  ...
  public class CAsyncFile : IDisposable
  {
    ...
    public uint Crc32
    {
      get
      {
        ...
        return crc32 == 0U ? 0U : ~crc32;
      }
    }

    public uint Crc32NoMask => this.m_crc32;
    ...
    public unsafe int GetCompressedSize(string fpath, uint* crc32)
    {
    ...
    public unsafe int GetCompressedSize(string fpath) => this.GetCompressedSize(fpath, (uint*) 0);
    ...
    public unsafe uint GetCrc32(ulong offset, ulong readsize)
    {
      ...
      this.WaitForComplete();
      void* dataPointer1 = this.m_data_pointer;
      if ((IntPtr) dataPointer1 == IntPtr.Zero)
        return 0;
      void* ptr = dataPointer1;
      int num = (int) (uint) readsize;
      int crc32 = (int) CCrc32.CalcCrc32((uint) num, (uint) num, ptr);
      void* dataPointer2 = this.m_data_pointer;
      if ((IntPtr) dataPointer2 == IntPtr.Zero)
        return (uint) crc32;
      if (this.m_extbuf == null)
        \u003CModule\u003E.FreeMemory(dataPointer2);
      this.m_data_pointer = (void*) 0;
      return (uint) crc32;
    }
    ...
    public static unsafe uint GetCrc32(string fpath)
    {
      ...
      if (File.Exists(fpath) && (IntPtr) casyncFile.m_file == IntPtr.Zero)
      {
        ...
        if (casyncFile.Open(fpath, CAsyncFile.OpenMode.Read, false))
        {
          ...
          casyncFile.ReadAlloc(0UL, filesize1, CAsyncFile.ReadMode.Normal, filesize1);
          casyncFile.WaitForComplete();
          void* dataPointer1 = casyncFile.m_data_pointer;
          ulong filesize2 = casyncFile.m_filesize;
          ulong length = filesize2;
          int crc32 = (int) CCrc32.CalcCrc32((uint) filesize2, (uint) length, dataPointer1);
          void* dataPointer2 = casyncFile.m_data_pointer;
          if ((IntPtr) dataPointer2 != IntPtr.Zero)
          {
            if (casyncFile.m_extbuf == null)
              \u003CModule\u003E.FreeMemory(dataPointer2);
            casyncFile.m_data_pointer = (void*) 0;
          }
          casyncFile.Close();
          return (uint) crc32;
        }
      ...
      ulong allocsize)
    {
      ...
      {
        if (allocsize > (ulong) extbuf.ReadBufferSize)
          return;
        CAsyncFile casyncFile = this;
    ...
    private unsafe int InternalWrite()
    {
      ...
      if (this.m_write_mode == CAsyncFile.WriteMode.TyrCompress)
      {
        ...
        if (this.m_enable_crc_check)
        {
          ...
          this.m_crc32 = CCrc32.CalcCrc32Cont((uint) num3, (uint) num3, ptr);
        }
      }
      uint num4 = (uint) num1;
      int num5 = (int) \u003CModule\u003E.fwrite(ptr, 1U, num4, this.m_file);
      if ((IntPtr) voidPtr != IntPtr.Zero && this.m_extbuf == null)
        \u003CModule\u003E.FreeMemory(voidPtr);
      if (num5 != (int) num4)
      {
        ulong num6 = num1;
        ...
        do
        {
          ...
          if (reader.m_stat != CAsyncFile.AsyncStatus.Error)
          {
            if (this.m_enable_crc_check)
            {
              ...
              iniCrc32 = CCrc32.CalcCrc32Cont(iniCrc32, (uint) (int) num2, dataPointer);
            }
...
label_10:
        ...
        return;
label_11:
        this.m_crc32 = this.m_read_size != 0UL ? iniCrc32 : 0U;
      }
      else
      {
        ...
        this.m_reader.WaitForComplete();
        CAsyncFile reader1 = this.m_reader;
        if (reader1.m_stat == CAsyncFile.AsyncStatus.Error)
        {
          Console.WriteLine("Copying .. Read error");
          CAsyncFile reader2 = this.m_reader;
          void* dataPointer = reader2.m_data_pointer;
          if ((IntPtr) dataPointer != IntPtr.Zero)
          {
            if (reader2.m_extbuf == null)
              \u003CModule\u003E.FreeMemory(dataPointer);
            reader2.m_data_pointer = (void*) 0;
          }
          this.m_stat = CAsyncFile.AsyncStatus.Error;
        }
        else
        {
          ...
          this.m_writer.WaitForComplete();
          if (this.m_enable_crc_check)
            this.m_crc32 = this.m_read_size != 0UL ? this.m_writer.m_crc32 : 0U;
          this.m_reader.ReleaseBuffer();
