...
namespace CriCpkMaker
{
  public class CGroupingManager
  {
    ...
    private void UpdateFileInfoPackingOrderEnum(object obj, object userObject)
    {
      ...
      do
      {
        cfileInfoLink.FileListContinuous[index].PackingOrder = this.indexOrder;
        ++this.indexOrder;
        ++index;
      }
      while (index < cfileInfoLink.FileListContinuous.Count);
    }
...
label_14:
    ...
    public void DebugPrintAttributeInfo()
    {
      ...
      foreach (string key in (IEnumerable) this.attrTable.Keys)
      {
        ...
        ++num1;
        string str = "\"";
        Console.WriteLine("[{0,4}] {1,-14} : Index={2, -4} Align={3,-4}", (object) num2, (object) (str + key + str), (object) cattrInfo.Index, (object) cattrInfo.Alignment, __arglist ());
      }
    }
